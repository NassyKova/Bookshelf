...
def _seed():
    ...
    book04 = Book("Sally Rooney", "Conversations with Friends", "Letter excache between two friends, one is a published author, another lives anordinary life, include other people, plus a third friend, politic and God believer")
